...
1. **Wiki Card (AI)** — highlight a word or phrase → AI + Wikipedia/Wiktionary build a reading note → send to your wiki default deck (configure under **Card defaults → Wiki Card**). Anki note type: **Wiki Card**.
